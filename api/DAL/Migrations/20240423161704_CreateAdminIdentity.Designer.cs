...
namespace DAL.Migrations
{
    ...
    [Migration("20240423161704_CreateAdminIdentity")]
    partial class CreateAdminIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "81a88b9c-e7de-4d90-a872-37efda16d1b3",
                            Email = "illiateliuk@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ILLIATELIUK@GMAIL.COM",
                            NormalizedUserName = "illiateliuk@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEJOR+Qdvw/1unENiUgpHXRe6jmmVidC5z0gnqaeoINnq1Ss+oavWaSP0ShLm8SBocQ==",
            ...
            modelBuilder.Entity("RecipeRecipeIngredient", b =>
                {
                    b.HasOne("Core.Models.Ingredient.RecipeIngredient", null)
                        .WithMany()
                        .HasForeignKey("IngredientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Recipe", null)
                        .WithMany()
